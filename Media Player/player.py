...
"")
        ...
        self.pushButton_camera.setGeometry(QtCore.QRect(150, 10, 121, 31))
...
class videoPlayer(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # self.ui.pushButton_fps.clicked.connect(self.display_fps)
    ...
    def open_camera(self):
        ...
        out = cv2.VideoWriter('F:/Computer Vesion/Assignment_videoApp/capture_videos/output.avi' , focus , 20.0 ,(player_width , player_height) )
        ...
        while True:
            if not self.paused:  # Check if video is paused
                ...
                if ret:
                    ...
                    # Check for space button press to pause the video
                    if cv2.waitKey(1) & 0xFF == ord(' '):
                        self.paused = True
                else:
                    break
            else:
                # Check for space button press to resume the video
                if cv2.waitKey(1) & 0xFF == ord(' '):
                    self.paused = False
